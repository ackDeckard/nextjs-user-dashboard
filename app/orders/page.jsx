    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-4">
        <div className="m-auto w-full overflow-y-auto rounded-lg border bg-white p-4">
          <div className="my-3 grid cursor-pointer grid-cols-2 items-center justify-between p-2 sm:grid-cols-3 md:grid-cols-2">
            <span>Order</span>
          ...
          <ul>
            {data.map((order, id) => (
              <li
                key={id}
                className="my-3 grid cursor-pointer grid-cols-2 items-center justify-between rounded-lg bg-gray-50  py-2 hover:bg-gray-100 sm:grid-cols-3 md:grid-cols-4"
              >
                <div className="flex">
